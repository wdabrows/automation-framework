...
public class SearchPage {
    ...
    public static WebElement findSortMenu(WebDriver driver){
     ...
     public static WebElement findSortType(WebDriver driver){
     ...
     public static WebElement findFirstItem(WebDriver driver){
